sequenceDiagram
    ...
    participant UI
    participant Sistema
    participant Piston as Entorno de Ejecución
    ...
    Sistema->>Sistema: Evaluar estado de finalización (Señal)
    alt Interrupción forzada detectada (SIGKILL)
        Sistema->>Sistema: Añadir un mensaje de error explicativo añadido al stderr
    end
