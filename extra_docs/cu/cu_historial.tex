...
\begin{longtable}{|p{15cm}|}
  ...
  1. El usuario carga la interfaz principal. \newline
  2. El frontend realiza una petición asíncrona (GET) para obtener el listado paginado de sesiones del usuario. \newline
  3. El backend valida la identidad y devuelve las sesiones ordenadas por última actualización descendente. \newline
  4. La interfaz pinta las sesiones en el panel lateral. \newline
