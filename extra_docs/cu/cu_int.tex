...
\begin{longtable}{|p{15cm}|}
  ...
  \begin{tabularx}{\linewidth}{@{}p{7.5cm}p{7.5cm}@{}}
    \textbf{Identificador:} CU1 & \textbf{Actor principal:} Usuario 
  \end{tabularx} \\ \hline
  ...
  \rowcolor{ulepsbased}
  \textbf{Descripción:} \newline 
  El usuario envía una pregunta al tutor socrático, opcionalmente acompañada del código de su editor y la última salida de ejecución. El sistema modera la entrada, genera una respuesta pedagógica en streaming (SSE) y opcionalmente modera la salida en paralelo. \\ \hline
  ...
  1. El usuario escribe un mensaje en el chat y pulsa enviar.\newline
  ...
  4. El sistema guarda el mensaje del usuario en la base de datos.\newline
  ...
  7. Si la moderación de input está activada envía el texto del usuario al LLM de moderación, si el veredicto es OK, continúa.\newline
  ...
  1. El mensaje del usuario se almacena en la base de datos. \newline
