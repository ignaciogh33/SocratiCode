...
\paragraph{Casos de uso secundarios.}
...
\begin{longtable}{|p{15cm}|}
  ...
  \endfoot
  \hline
  \caption{Caso de uso 4 — Registro de usuario en la plataforma.}
  ...
  2. Introduce nombre de usuario, correo electrónico, y repite dos veces una contraseña segura. \newline
...
\begin{longtable}{|p{15cm}|}
  ...
  \endfoot
  \hline
  \caption{Caso de uso 5 — Inicio de sesión en la plataforma.}
  \label{TB:CU5_LOGIN}
  \endlastfoot
...
\begin{longtable}{|p{15cm}|}
  ...
  \endfoot
  \hline
  \caption{Caso de uso 6 — Cierre de sesión.}
  \label{TB:CU6_LOGOUT}
  \endlastfoot
...
\begin{longtable}{|p{15cm}|}
  ...
  \endfoot
  \hline
  \caption{Caso de uso 7 — Modificación de datos del perfil.}
...
\begin{longtable}{|p{15cm}|}
  ...
  \endfoot
  \hline
  \caption{Caso de uso 8 — Cambio de contraseña.}
...
\begin{longtable}{|p{15cm}|}
  ...
  \endfoot
  \hline
  \caption{Caso de uso 9 — Recuperación de contraseña olvidada.}
...
\begin{longtable}{|p{15cm}|}
  ...
  \endfoot
  \hline
  \caption{Caso de uso 10 — Renombrado manual de sesión de chat.}
...
\begin{longtable}{|p{15cm}|}
  ...
  \endfoot
  \hline
  \caption{Caso de uso 11 — Eliminación permanente de sesión de chat.}
  ...
  2. El frontend muestra un cuadro de diálogo de confirmación \textit{«¿Eliminar esta conversación? Esta acción no se puede deshacer.»}. \newline
...
\begin{longtable}{|p{15cm}|}
  ...
  \endfoot
  \hline
  \caption{Caso de uso 12 — Consulta del historial de sesiones y mensajes.}
