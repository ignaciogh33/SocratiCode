...
\begin{longtable}{|p{15cm}|}
  ...
  \hline
  \caption{Caso de uso 2 — Compilación y ejecución de código en Piston.}
  \label{TB:CU2_PISTON}
  \endlastfoot
  ...
  \rowcolor{ulepsbased}
  \textbf{Flujo principal:} \newline
  1. El alumno pulsa el botón ``Ejecutar'' en el editor con código y el lenguaje seleccionado.\newline
...
\begin{longtable}{|p{15cm}|}
  ...
  % --- PIE FINAL (Caption abajo) ---
  \hline
  \caption{Caso de uso 3 — Configuración global por el administrador.}
