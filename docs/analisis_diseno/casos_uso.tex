...
\begin{figure}[Diagrama de secuencia CU1]{FIG:CU1_SEQ}{Diagrama de secuencia de la interacción del chat con streaming.}
    \centering
    \includegraphics[width=0.85\textwidth]{./diagramas/secuencia_chat_stream_SIMPLE.pdf}
\end{figure}
...
\begin{figure}[Diagrama de secuencia CU2]{FIG:CU2_SEQ}{Diagrama de secuencia de ejecución de código en Piston.}
    \centering
    \includegraphics[width=0.85\textwidth]{./diagramas/secuencia_ejecucion_piston_SIMPLE.pdf}
\end{figure}
...
\end{longtable}
\endgroup
\begin{figure}[Diagrama de secuencia CU3]{FIG:CU3_SEQ}{Diagrama de secuencia de la configuración global del sistema.}
    \centering
    \includegraphics[width=0.85\textwidth]{./diagramas/secuencia_config_admin_SIMPLE.pdf}
\end{figure}
