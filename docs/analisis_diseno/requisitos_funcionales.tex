\begin{functional}
    ...
    \item Configuración global de parámetros: El administrador podrá gestionar a través de la interfaz de administración los parámetros globales del sistema, incluyendo la selección de los modelos de lenguaje principal y de moderación (entre los disponibles), así como el alcance de la supervisión de mensajes (entrada, salida, ambos o ninguno) y el umbral de palabras para la moderación de salida. El sistema garantizará la existencia de un único conjunto de ajustes activos para toda la plataforma.
